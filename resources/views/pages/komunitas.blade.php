...
<div id="mobileNavMenu" class="hidden md:hidden fixed inset-x-0 top-[80px] z-40 bg-white/95 backdrop-blur-md shadow-lg border-b border-gray-200">
    <div class="flex flex-col p-6 space-y-4">
        ...
        <a class="text-primary font-bold text-lg border-b-2 border-primary pb-2" href="{{ route('komunitas') }}" onclick="toggleMobileNav()">Komunitas</a>
...
<main class="pt-[120px] pb-xl px-margin-mobile md:px-margin-desktop max-w-[1440px] mx-auto overflow-hidden">
