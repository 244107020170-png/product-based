...
<div class="space-y-8">
    <div class="flex items-center gap-4">
        <a href="{{ route('admin.users') }}" class="flex items-center gap-2 text-adm-outline hover:text-adm-dark transition-colors">
        ...
        <div class="flex items-start gap-6">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-4 mt-4">
                    <span class="px-3 py-1 bg-adm-secondary-container/20 text-adm-on-secondary-container rounded-full font-adm-body text-adm-label-sm">Player</span>
    ...
    <div class="bg-adm-surface-lowest rounded-[20px] soft-shadow border border-adm-outline-variant overflow-hidden">
        <div class="px-8 py-5 border-b border-adm-outline-variant">
            <h3 class="font-adm-headline text-adm-headline-sm text-adm-primary">Riwayat Booking</h3>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-adm-outline-variant">
                    ...
                    <tr class="hover:bg-adm-surface-low/50 transition-colors">
                        ...
                        <td class="px-8 py-4"><span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-adm-success/10 text-adm-success">{{ $booking->status }}</span></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
