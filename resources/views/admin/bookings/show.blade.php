...
<div class="space-y-8">
    <div class="flex items-center gap-4">
        <a href="{{ route('admin.bookings') }}" class="flex items-center gap-2 text-adm-outline hover:text-adm-dark transition-colors">
    ...
    <div class="bg-adm-surface-lowest rounded-[20px] soft-shadow border border-adm-outline-variant p-8">
        ...
        <div class="grid grid-cols-2 gap-8 mt-8 pt-8 border-t border-adm-outline-variant">
            <div>
                <h3 class="font-adm-body text-adm-label-md text-adm-outline uppercase mb-4">Informasi User</h3>
        ...
        <div class="mt-8 pt-8 border-t border-adm-outline-variant">
            <h3 class="font-adm-body text-adm-label-md text-adm-outline uppercase mb-4">Detail Booking</h3>
