    ...
    public function index()
    {
        ...
        $badges = [
            [
                ...
                'current' => $currentLevel['name'] === 'Pemula',
            ],
            [
                'name'    => 'Aktif',
                'range'   => '6-20 Poin',
                ...
                'current' => $currentLevel['name'] === 'Aktif',
            ],
            [
                'name'    => 'Pro',
                'range'   => '>20 Poin',
